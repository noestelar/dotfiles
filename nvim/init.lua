	...
	-- Snacks.nvim (dependency for Claude Code)
	{
		...
		opts = {
          ...
          center = {
            ...
            { icon = " ", name = "Recent Files", key = "r", action = "Telescope oldfiles" },
            { icon = " ", name = "Find File", key = "f", action = "Telescope find_files" },
            { icon = " ", name = "Find Word", key = "g", action = "Telescope live_grep" },
            { icon = " ", name = "Lazy", key = "l", action = "Lazy" },
